...
public class YoutubeDL {
    ...
    static final String baseName = "youtubedl-android";
    static final String youtubeDLName = "youtube-dl";
    static final String youtubeDLFile = "youtube_dl.zip";
    ...
    public VideoInfoCollection getInfo(String url) throws YoutubeDLException, InterruptedException {
        return VideoInfoCollection.getInfo(url);
    }
